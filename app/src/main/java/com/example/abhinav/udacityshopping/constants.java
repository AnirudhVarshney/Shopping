...
public static final String FIREBASE_LOCATION_ACTIVE_LIST=FIREBASE_URL+"/"+"List";
    public static final String FIREBASE_LOCATION_ACTIVE_LIST_Up=FIREBASE_LOCATION_ACTIVE_LIST+"/"+"activeList";
    public static final String FIREBASE_LOCATION_ACTIVE_LIST_Items=FIREBASE_URL+"/"+"ShoppingListItems";
    /**
